                ...
                <div class="uk-form-controls">
                    ...
                    <?php foreach ($services as $key => $service) : ?>
                        ...
                        <label for="service<?php echo $service['id']; ?>" class="uk-display-block" style="padding-top: 6px;">
                            <input class="uk-checkbox" name="services[]" type="checkbox" <?php if ($key > -1) : ?>checked<?php endif; ?> id="service<?php echo $service['id']; ?>" value="<?php echo $service['id']; ?>"> <?php echo $service['name']; ?>
                        </label>
                    <?php endforeach; ?>
